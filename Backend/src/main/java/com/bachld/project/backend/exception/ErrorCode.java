...
public enum ErrorCode {
    ...
    OUT_OF_SUBMISSION_WINDOW(1218, "Ngoài thời gian nộp đề cương", HttpStatus.BAD_REQUEST),
    NO_ACTIVE_SUBMISSION_WINDOW(1217, "Chưa tới thời gian nộp đề cương", HttpStatus.BAD_REQUEST),
